...
const photos = [
  { className: "photo-main", src: "/hero-gathering-crop.jpg", alt: "Faith on the Frontlines gathering" },
      ...
      <div className="hero-copy">
        <div className="hero-content">
          <h1 id="hero-heading" className="hero-title">
            <Image className="hero-wordmark" src="/logos/faith-on-the-frontlines-lockup.png" alt="Faith on the Frontlines" width={1760} height={840} priority />
          </h1>
